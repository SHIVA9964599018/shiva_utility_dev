...
def add_jobs_to_cart(jobs,mapping_inputs, driver_index):
    ...
    from_env = driver.find_element(By.XPATH,f"//table[@id='source_env_table']//tr[td[text()='{mapping_inputs[0]}']]//input[@type='radio']")
    from_env.click()
    sleep(1)
    ...
    Next_button_2.click()
    sleep(2)
    to_env = driver.find_element(By.XPATH, f"//table[@id='target_env_table']//tr[td[2] = '{mapping_inputs[1]}']//input[@type='checkbox']")
    to_env.click()
    sleep(1)
    ...
    Ok_button_1.click()
    sleep(1)
    Host_group = driver.find_element(By.XPATH, f"//table[@id='host_apps_table']//tr[normalize-space(td[3]) = '{mapping_inputs[2]}']//input[@type='checkbox']")
    Host_group.click()
    sleep(1)
    runtime_user = driver.find_element(By.XPATH, f"//table[@id='user_apps_table']//tr[td[3]='{mapping_inputs[3]}']//input[@type='checkbox']")
    runtime_user.click()
    sleep(1)
    Variable_mapping = driver.find_element(By.XPATH, f"//table[@id='variable_apps_table']//tr[td[3]='{mapping_inputs[4]}']//input[@type='checkbox']")
